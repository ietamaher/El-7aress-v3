...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        lblGimbalSpeed->setGeometry(QRect(170, 620, 111, 17));
        ...
        elevationSlider->setOrientation(Qt::Orientation::Vertical);
        ...
        azimuthSlider->setOrientation(Qt::Orientation::Horizontal);
