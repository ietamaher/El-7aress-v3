#ifndef PLCRMOTESPANELSENSORINTERFACE_H
#define PLCRMOTESPANELSENSORINTERFACE_H
...
class PLCRemoteStationSensorInterface : public QObject {
    Q_OBJECT
public:
    explicit PLCRemoteStationSensorInterface(const QString &device,
                                     int baudRate,
                                     int slaveId,
...
#endif // PLCRMOTESPANELSENSORINTERFACE_H
